...
def find_duplicate_groups(image_paths: Sequence[str],
                          iou_threshold: float,
                          dataset_path: str = "") -> List[List[int]]:
    """
    ...
    if is_dice_dataset:
        print("Dice dataset detected - will only compare first 3 labels for duplicate detection")
